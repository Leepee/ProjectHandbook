...
By \textbf{27/10/2023} at the latest you should have produced and signed a Project Proposal (one-pager, not graded):
...
By \textbf{17/11/2023} (assignment deadline) you should produce a Project Definition Report (20\%):
...
By \textbf{3/5/2024} (assignment deadline) you should submit your Final Report (70\%):
...
\begin{itemize}
    ...
    \item A printed and bound copy to be submitted as well as an online copy
...
Around \textbf{20/5/2024 - 24/5/2024} (assignment deadline) you should produce an appropriate poster to present on Poster day (exhibition date to be confirmed)(10\%).
...
\begin{tcolorbox}
    Students who have not agreed and signed proposals by the 27\textsuperscript{th} of October may be assigned a project idea and supervisor. 
\end{tcolorbox}
...
\begin{tcolorbox}
    The definition is an important assignment in the Media Technology Project module, and is worth 20\% of the final grade. It must be submitted by 17/11/2023 in PDF format \textit{only}. 
\end{tcolorbox}
...
\begin{tcolorbox}
    A printed and bound copy of the project final report must be submitted. You may want to print an extra copy for yourself, and for use on the poster day, as the supervisor will keep the original and it may be marked up. An electronic copy must also be submitted by 4pm on the same date.
\end{tcolorbox}
